...
import 'package:myapp/features/ai_conversation/my_ai_binindgs.dart';
import 'package:myapp/features/ai_conversation/my_ai_view.dart';
...
List<GetPage> getPages = [
  GetPage(name: RoutesConstant.splashPage,
      page: () => SplashPageView(),
      binding: SplashPageBinidngs()),
  GetPage(name: RoutesConstant.loginPage,
      page: () => LoginPageView(),
      binding: LoginPageBinidngs()),
  GetPage(name: RoutesConstant.homePage,
      page: () => HomePageView(),
      binding: HomePageBindings()),
  GetPage(name: RoutesConstant.parentDashboard,
      page: () => ParentDashboardView(),
      binding: ParentDashboardBindings()),
  GetPage(name: RoutesConstant.therapistDashboard,
      page: () => TherapistDashboardView(),
      binding: TherapistDashboardBinding()),
  GetPage(name: RoutesConstant.therapycenterDashboard,
      page: () => TherapycenterDashboardView(),
      binding: TherapycenterDashboardBinding()),
  GetPage(name: RoutesConstant.schedulePage,
      page: () => SchedulePageView(),
      binding: SchedulePageBindings()),
  GetPage(name: RoutesConstant.taskPage,
      page: () => TasksPageView(),
      binding: TaskPageBindings()),
  GetPage(name: RoutesConstant.settingsPage,
      page: () => SettingsPageView(),
      binding: SettingsPageBindings()),
  GetPage(name: RoutesConstant.communityPage,
      page: () => CommunityPageView(),
      binding: CommunityPageBindings()),
  GetPage(name: RoutesConstant.patientProfile,
      page: () => PatientProfileView(),
      binding: PatientProfileBinidngs()),
  GetPage(name: RoutesConstant.therapistProfile,
      page: () => TherapistProfileView(),
      binding: TherapistProfileBindings()),
  GetPage(name: RoutesConstant.centerProfile,
      page: () => TherapycenterProfileView(),
      binding: TherapycenterProfileBindings()),
  GetPage(name: RoutesConstant.conversationPage,
      page: () => ConversationsPageView(),
      binding: ConversationsPageBinindgs()),
  GetPage(name: RoutesConstant.messagesPage,
      page: () => MessageDetailView(),
      binding: MessagePageBindings()),
  GetPage(name: RoutesConstant.patientsPage,
      page: () => PatientsPageView(),
      binding: PatientsPageBindings()),
  GetPage(name: RoutesConstant.therapistPage,
      page: () => TherapistPageView(),
      binding: TherapistPageBindings()),
  GetPage(name: RoutesConstant.myJobs,
      page: () => MyJobsView(),
      binding: MyJobsBindings()),
  GetPage(name: RoutesConstant.jobPost,
      page: () => JobPostView(),
      binding: JobPostBindings()),
  GetPage(name: RoutesConstant.myAi,
      page: () => MyAiView(),
      binding: MyAiBinindgs()),
